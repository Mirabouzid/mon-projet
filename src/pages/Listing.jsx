...
export default function Listing() {
    ...
    return (
        <main>
            ...
            <div className='fixed top-[70px] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12 h-12 flex justify-center items-center'
                onClick={() => {
            ...
            <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
                <div className='w-full '>
                    ...
                    <div className='flex justify-start items-center space-x-4 w-[75%]'>
                        <p className='bg-red-800 w-full maw-w-[200px] rounded-md p-1 text-white text-center font-semibold shadow-md'>
                    ...
                    <ul className='flex items-center space-x-2 sm:space-x-10 text-sm font-semibold mt-6  '>
                        ...
                        <li className='flex items-center whitespace-nowrap'>
                            ...
                            {+listing.bathrooms > 1 ? `${listing.bathrooms} Beds` : "1 Baths"}
                        </li>
